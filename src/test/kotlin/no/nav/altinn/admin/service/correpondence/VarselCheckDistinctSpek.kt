...
object VarselCheckDistinctSpek : Spek({
    describe("Testing of distinct varsel") {
        it("Varsel Tittel sjekk: Har en lik tittel") {
        ...
        it("Varsel Melding sjekk: Har en lik melding") {
            val varsler = mutableListOf<Varsel>()
            val ekstraMottaker = mutableListOf<Mottaker>()
            ekstraMottaker.add(Mottaker(ForsendelseType.Email, "alf@nav.com"))
            val ekstraMottaker2 = mutableListOf<Mottaker>()
        ...
        it("Varsel Mottaker sjekk: Har en lik spesifisert mottaker epost adresse") {
            val varsler = mutableListOf<Varsel>()
            val ekstraMottaker = mutableListOf<Mottaker>()
            ekstraMottaker.add(Mottaker(ForsendelseType.Email, "alf@nav.com"))
            val ekstraMottaker2 = mutableListOf<Mottaker>()
